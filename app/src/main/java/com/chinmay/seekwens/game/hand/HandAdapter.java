...
public class HandAdapter extends FirebaseRecyclerAdapter<Card, HandCardViewHolder> {
    ...
    public HandCardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new HandCardViewHolder(view, new MyHandCardClickListener());
    }
    ...
    private class MyHandCardClickListener implements HandCardViewHolder.HandCardClickListener {
        @Override
